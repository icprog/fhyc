...
int CMyDate::CalMonthDays(string Date)
{
    int MonthDays[] = {0,31,28,31,30,31,30,31,31,30,31,30,31};
    int i;
    int Year = atoi(Date.substr(0,4).c_str());
...
int CMyDate::CalMonthDays()
{
    int MonthDays[] = {0,31,28,31,30,31,30,31,31,30,31,30,31};
    int i;
    int Year = atoi(m_cDate.substr(0,4).c_str());
    int Month = atoi(m_cDate.substr(5,2).c_str());
    if(true == IsLeapYear(Year))
        MonthDays[2] = 29;
    return MonthDays[Month];
}
...
//    cout<<"CalWeekSeq(string Date)"<<endl;
